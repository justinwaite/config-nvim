...
if vim.g.vscode then
  ...
  -- end, { desc = 'Open the auto fix menu' })
  ...
  require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
      ...
      dependencies = {
        ...
        -- Ability to pass ripgrep args to the live_grep feature (<leader> sG)
      ...
      config = function()
        ...
        require('telescope').setup {
          ...
          defaults = {
            ...
            -- View previous pickers in the current session
            cache_picker = {
              num_pickers = 20,
              limit_entries = 1000,
            },
            ...
            -- Better display of filenames and paths
            path_display = { 'smart' },

            -- Show the filename at the top of the picker
        ...
        vim.keymap.set('n', '<leader>sG', ":lua require('telescope').extensions.live_grep_args.live_grep_args()<CR>", { desc = '[S]earch [G]rep with args' })
        ...
        local servers = {
          ...
          cssls = {
            settings = {
              css = {
                lint = {
                  -- Ignore unknown-at-rules for the sake of tailwindcss @apply syntax
          ...
          -- Use the vscode eslint lanugage server instead of configuring with conform for code actions
    ...
    { -- Collection of various small independent plugins/modules
      ...
      config = function()
        ...
        statusline.setup { use_icons = vim.g.have_nerd_fond }
    ...
    { -- Highlight, edit, and navigate code
      ...
      opts = {
        ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'tsx', 'typescript' },
